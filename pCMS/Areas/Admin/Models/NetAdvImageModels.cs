...
namespace pCMS.Admin.Models
{
    ...
    public class NetAdvDirectoryService
    {
        ...
        public TreeViewItemModel GetDirectoryRecursive(DirectoryInfo directory, TreeViewItemModel parentItem, HttpContextBase ctx)
        {
            ...
            var expandedNodes = ctx.Session[NetAdvImageSettings._netAdvImageTreeStateSessionKey] as List<string>;
            ...
            {
                var childNode = GetDirectoryRecursive(child, item, ctx);
        ...
        public static string _uploadPath
        {
            get
            {
                return
                    ...
                    ConfigurationManager.AppSettings["netAdvImage_UploadPath"] : "~/Content/Uploads/";
            }
        }
